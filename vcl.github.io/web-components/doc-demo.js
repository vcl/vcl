...
export default class DocDemo extends PolymerElement {
  static get template() {
    ...
    <div id="docDemo">
      <div class="tabbable">
        <div class="tabs tabStyleUni" role="tablist">
        ...
        <div class="tabContent">
          <div on-click="demoClick" id="ninja" name="ninja" role="tabpanel" class$="tabPanel docDemoContent transparent shadow {{getDemoClass(codeVisible)}}"></div>
          <div role="tabpanel" class$="tabPanel code {{getCodeTextClass(codeVisible)}}">
